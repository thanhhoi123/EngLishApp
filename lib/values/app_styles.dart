...
class AppStyles{
  static TextStyle h1 = TextStyle(fontFamily: FontFamily.sen, fontSize: 109.65, color: Colors.white);
  static TextStyle h2 = TextStyle(fontFamily: FontFamily.sen, fontSize: 67.77, color: Colors.white);
